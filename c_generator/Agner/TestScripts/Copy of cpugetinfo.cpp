//                       cpugetinfo.cpp                    © 2013-09-01 Agner Fog
//
// Get cpuid info:
...
// family:          Prints CPU family number as decimal number
// model:           Prints CPU model number as decimal number
// stepping:        Prints CPU stepping number as decimal number
...
struct InstrSet {
    int leaf;              // eax input to cpuid (ecx = 0)
...
static const InstrSet isets[] = {
    ...
    {0x80000001, C,  0, "LAHF_64"},
    {0x80000001, C,  5, "LZCNT"},
    {0x80000001, C,  6, "SSE4A"},
    {0x80000001, C,  8, "PREFETCHW"},
    {0x80000001, C, 11, "XOP"},
    {0x80000001, C, 16, "FMA4"},
    {0x80000001, C, 21, "TBM"},
    {0x80000001, D, 22, "MMXEXT"},
    {0x80000001, D, 27, "RDTSCP"},
    {0x80000001, D, 30, "3DNOWEXT"},
    {0x80000001, D, 31, "3DNOW"},
    // VIA instructions:
    {0xC0000001, D,  2, "XSTORE"},
    {0xC0000001, D,  3, "XSTORE_ENABLED"},
    {0xC0000001, D,  6, "XCRYPT"},
    {0xC0000001, D,  7, "XCRYPT_ENABLED"},
    {0xC0000001, D,  8, "ACE2"},
    {0xC0000001, D,  9, "ACE2_ENABLED"},
    {0xC0000001, D, 10, "XSHA"},
    {0xC0000001, D, 11, "XSHA_ENABLED"},
    {0xC0000001, D, 12, "MONTMUL"},
    {0xC0000001, D, 13, "MONTMUL_ENABLED"}
};
...
int main(int argc, char * argv[]) {
    ...
    if (argc > 1 && strstr(argv[1], "vendor")) {
        // print vendor only
    ...
    if (argc > 1) {  // print only one thing
